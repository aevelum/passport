...
- Removed `fail`/`fails` from readiness overclaim safe-boundary classifiers and added unsafe claim fixtures so failure-condition language cannot whitelist prohibited Passport capability claims.
