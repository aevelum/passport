...
const transcript = {
  ...
  privacyAssertions: [
    ...
    'CapacityReservation is visible only to Holder, Attester, and Verifier',
    'ReservationHandoffInstruction is metadata-only, nonconsuming, and visible to the handoff recipient',
    'AuditDisclosureGrant is visible to the Auditor and reveals only allowed metadata fields',
