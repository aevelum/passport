...
Passport can produce regulated-market readiness evidence and collateral-capacity artifacts. Adapter outputs remain external-format views over readiness attestations; they do not grant licenses, admit participants to a venue, execute trades, clear, settle, custody, transfer assets, issue tokens, or operate wallets.
